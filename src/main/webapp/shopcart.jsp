		...
		<div class="col-md-12 column">
			<nav class="navbar navbar-default" role="navigation">
				...
				<table class="layui-table">
					...
					<c:if test="${not empty shopppingCart}">
					<c:forEach items="${shopppingCart}" var="Order">								
						<tr>		
						...
						<td><a href="${pageContext.request.contextPath}/delshop/${Order.id}">删除</a></td>
		                <td><a href="${pageContext.request.contextPath}/buys/${Order.id}">购买</a></td>									
...
<c:if test="${empty shopppingCart}">
					<h1 style="color: red;">无商品</h1>
